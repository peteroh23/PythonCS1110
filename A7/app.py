...
class Invaders(GameApp):
    ...
    LIST MORE ATTRIBUTES (AND THEIR INVARIANTS) HERE IF NECESSARY
        lastkeys: number of keys pressed last frame
    ...
    def start(self):
        ...
        self._game = None
        self._wave = None
        self._text = GLabel(text = "Press any key to play!", linecolor = 'white',fillcolor = 'black', x = 400, y =350, font_size = 70, font_name = 'Arcade')
    ...
    def update(self, dt):
        ...
        if (self._wave != None and self._wave.checkPaused()):
            self._state = STATE_PAUSED

        if (self._wave != None and self._wave.checkGameOver()):
            self._state = STATE_COMPLETE

        if (self._wave != None and self._wave.allAliensDead()):
            self._state = STATE_COMPLETE

        if (self._wave != None and self._wave.aliensInvaded()):
            self._state = STATE_COMPLETE
    ...
    def draw(self):
        ...
        if (self._state == STATE_PAUSED):
            self._text = GLabel(text = "Press any key to continue playing!", linecolor = 'white',fillcolor = 'black', x = 400, y =350, font_size = 45, font_name = 'Arcade')
            self._text.draw(self.view)

        if (self._state == STATE_COMPLETE):
            self._text = GLabel(text = "GAME OVER! \n Thanks for Playing.", linecolor = 'white',fillcolor = 'black', x = 400, y =350, font_size = 50, font_name = 'Arcade')
            self._text.draw(self.view)
    ...
    def _determineStart(self):
        ...
        user must release th
        e key and press it again to change the state.
        """
