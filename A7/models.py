...
class Ship(GImage):
    ...
    def __init__(self, x, y, width, height, source):
        ...
        """
        super(Ship, self).__init__(x = x, y =y, width = width, height = height, source = source)
...
class Alien(GImage):
    ...
    def __init__(self, x, y, width, height, source):
        ...
        Initializer: Creates a GImage of an Alien
        """
        super(Alien, self).__init__(x = x, y =y, width = width, height = height, source = source)
...
class Bolt(GRectangle):
    ...
    def __init__(self, x, y, width, height, fillcolor, source, BOLT_SPEED):
        super().__init__(x = x, y = y, width = width, height = height, fillcolor = fillcolor)
        self._source = source
        if (self._source == 'Player'):
            self._velocity = BOLT_SPEED
        if (self._source == 'Alien'):
            self._velocity = -BOLT_SPEED
