...
def round(number, places):
    ...
    #2, adding 0.5 to the number
    x_2 = x_1 +0.5

    #3, convert the number to an int
    x_3 = int(x_2)

    #4, shift the number back to right decimal places
    if (places == 0):
        x_4 = x_3
...
def str5(value):
    ...
    Examples:
        ...
        str5(102) is '102.0'
        str5(360) is '360.0'
        str5(259.36) is '259.4'
        str5(1)       is  '1.000'.
        str5(0.12345) is '0.123'
    ...
    # Max number of places after the decimal is 4, places after decimal depend on numbers before
    places = 4 - decimal
